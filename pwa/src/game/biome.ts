...
export const TAIGA: Biome = {
  ...
  communities: [
    ...
    },
    {
      ...
      weight: 2.5,
      density: 0.8,
      trees: { pineTall: 12, pineYoung: 5, pineSapling: 4, pineCrooked: 3, juniper: 3, stump: 1 },
    ...
    },
    {
      ...
      weight: 2,
      density: 0.9,
      trees: { birch: 10, birchPair: 5, birchYoung: 6, rowan: 2, aspen: 2, spruceSapling: 2 },
    ...
    },
    {
      ...
      weight: 1.4,
      density: 0.14,
      trees: { spruceSapling: 8, pineSapling: 5, birchYoung: 4, juniper: 4, stump: 3, rowan: 2 },
    ...
    },
    {
      ...
      weight: 0.9,
      density: 0.22,
      trees: { stump: 10, spruceSapling: 5, birchYoung: 3, fallenBranch: 3, spruceYoung: 2 },
