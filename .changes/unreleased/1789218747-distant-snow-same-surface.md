---
type: Fixed
title: Distant snow is the same snow as the snow under the car
---
...
same off-white noise field — so a winter stage is one snowfield from the
bonnet to the skyline. The glitter also fades out with DISTANCE rather than
stopping at the coat's edge, which takes the crawling speckle off ground too
far away for a crystal to be bigger than a pixel.
