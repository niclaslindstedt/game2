...
Every campaign stage now pays points to its podium the way a kart game does
— three for the win, two for second, one for third — to you and to the
fourteen rival crews alike. The results card says what your place was worth
and where the location's season now stands, and FULL RESULTS opens the whole
...
stage driven again keeps whichever run paid you more, so a lap for fun can
