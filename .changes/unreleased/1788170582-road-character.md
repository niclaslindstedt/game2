---
type: Changed
title: Roads that read like roads
---
...
pushed to the outside of the bend — instead of sitting flat.

The anti-cut blocks at an apex are bedded into the verge rather than standing
on it. Cutting a corner over them now costs about a fifth of the car's speed,
which is a price you pay on purpose; it used to take almost all of it.

And the tarmac sweeps. A public road the rally borrowed no longer has
hairpins on it — where the surfacing reaches one, it simply runs out and the
road is gravel through the corner.
