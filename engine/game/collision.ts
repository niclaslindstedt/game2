...
import { massRatio, restitutionAt } from "./structure.ts";
import { updateSlip, type CarState, type GameEvent, type RunStats } from "./state.ts";
import { damageZoneAt, dealCrush } from "./crush.ts";
