...
| `make biomes`      | Photograph each country with the game itself, from 200 m over its first stage's start line, into `pwa/public/previews/`                                                            |
