...
Scandinavian Flick is an arcade rally game — no account, no download. Pick your stage length (one minute to seven — or endless), your conditions (dawn, day, dusk, or night; clear, rain, or storm), and START. The feel is the point: drifts that are simply what happens when you turn at speed, jumps where the air is committed and slightly out of control, water fords that explode, tarmac sections where the grip suddenly holds and the tires smoke instead of the gravel flying, a seeded wind that leans on the car and rips the exhaust fumes sideways. Stages are generated fresh from a seeded rules engine that respects rally reality — point-to-point sprints, or **circuits**: a closed lap that comes back to its own start line, raced over three of them with the lap board running: braking zones before hairpins, run-ups before jumps, one river per valley with fords where it is shallow and timber or concrete bridges where it is not, public roads the stage joins at proper junctions and leaves again (the arm it abandons taped off — and still drivable, if you want to see where it goes), grades that climb on the straights and flatten through corners — rolling through a landscape of hillsides, mountains, and lakes that glitter in the sun. And the landscape is not a backdrop: leave the road and drive it — forests, cliff edges that launch the car, streams, boulders and fallen trunks that are really there, all the way to the open sea. There is no speed limit out there: the wild digs at the driven wheels off the line so it takes half again as long to get going, but nothing caps the top end — find ground flat and open enough and the car runs out to the same ~190–240 km/h it does on the stage, and whatever is at the end of that run is a jump taken at the speed it was worth. Every stage is split by CHECKPOINTS — a board every fifteen seconds or so, always just past the exit of a corner, and the tighter the corner the likelier it is to be marked — so the clock is read in pieces against the ghost as you go, and drowning, or giving up and asking for the road back, costs you everything since the last one. Each board flashes what the piece of road behind you took, and cover it quicker than it has ever been covered on that machine and it says NEW RECORD. A co-driver strip calls every corner two seconds before it arrives — two seconds at the speed you are doing, so it comes up further out the faster you go — and it calls it with no words on it at all: the sign IS the corner, the real bend drawn off the stage, coloured by how much it is going to ask and cut to a point on the side the road turns toward, and it lights up as the bend goes by — the drawn road coming up in the corner's own colour, then the arrow's head filling from its base to its point, standing whole as you straighten up and gone the moment the corner is behind you — so the call is read out of the corner of an eye that never leaves the road. In the campaign those boards are also where you find out where you stand: fourteen other crews are on the same road at the same time, driven by the real bot on real skill, and your place at a board is every car already through it plus one — and where you finish is worth points, three for a stage win down to one for third, adding up over a location into a table you have to TOP to leave the country — run any stage again, as often as you like, for a better place, time and points. The endless stage just keeps generating road from the seed until you stop. Four dials say what kind of country you want it built in — hills, water, forest, tarmac. Everyone gets the same stage on a given day; every finish rolls into the next one.
...
| `make wheel`       | Photograph a wheel coming off (`previews/wheel.png`): the throw, the bounces, the roll — frame by consecutive frame, from three seats                                              |
