---
title: Key the land field's memo on every dial — a hand-listed key silently serves one dial's biome to another
date: 2026-09-09
...
missing too — so a sweep that varied the dial got the FIRST build's biome
...
built from another stage's biome.
