---
title: A fill's crest is rounded over a RUN sized to the lattice, never to a fixed bend — a bend holds a hillside fill out over the falling land
date: 2026-09-06
...
class on every biome, and the ribbon's edge standing over a trench.
...
holding the fill out over the falling land the whole way and landing
