---
title: An elevation band is a percentile of its OWN biome — the same treeline metres mean different things in two biomes
date: 2026-09-09
...
ABSOLUTE heights, and a biome with no massif floats up and down by seed —
...
was painted solid bedrock, and any seed whose biome ran high came out grey
...
**Before moving a band, measure the land's own height distribution in the
...
`tests/alpine_test.ts`'s pinned digests can still pass while the biome the
