...
node scripts/skill-lessons.mjs mapgen-improvement --concepts=jumps,fords
...
date: YYYY-MM-DD
scope: engine/sim/, engine/game/defs/
concepts: [drift, bot-tuning, corner-speed]
---
...
concepts (`drift`/`drifting`, `sim`/`simulation`) get merged in the same pass.
