...
The **car** is picked on any of those pages, turning on its stand. **Time of day** (dawn, day, dusk, night) and **weather** (clear, rain, storm — weather sets the wind, and the wind leans on the car) are yours on Roam and authored into each campaign stage. Pick a stage and you sit on the line under a rally start gantry — three reds filling a lamp a second, a tick on each, then all green and away.
