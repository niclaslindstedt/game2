...
- **Campaign** — a location (Taiga, for now) and its six stages, each one unlocked by getting on the **podium** of the one before it, and the location after it unlocked by winning its **championship**. Locked stages wear a grey border and a padlock; open ones wear green. The ladder climbs in both length and difficulty, from a 1-minute forest road to seven minutes of hairpins and jumps in a night storm — and then changes discipline: the last two are **circuits**, three laps of a closed lap that comes back to its own start line, where you get to learn the road and the clock is the whole opponent.
  ...
  You are not out there alone. Every campaign stage is run against **fourteen other crews**, leaving the start control ten seconds apart the way a real rally does, and you are the last car on the road — so everybody ahead of you is already driving, and there is nothing to overtake, only times to beat. Your **position** rides in the top right, beside the map, and it moves at every split board: your place is every car already through that board, plus you. The split itself names the crew you are measured against — the leader through it. **Finish in the top three and the stage is cleared**; finish outside it and the card at the line says TOO SLOW, and the stage is still yours to run again. **RIVALS** on the stage list picks how good the field is — EASY, MEDIUM or HARD. Each stage box remembers your best finishing position at the setting you are looking at, above your best time.
