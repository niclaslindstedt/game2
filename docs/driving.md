...
| Snow        | The alpine road above its snowline (R47): packed snow over whatever was laid — barely half of gravel's grip, a breakaway a third further out, a little more drag and a share of the throttle spun away, a slide that runs further and settles later than any other, and a give that takes a landing before the shell does. Same loose-surface rubber |
