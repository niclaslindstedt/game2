...
- **R33** A GRAVEL road is not smooth, and a SEALED one is. The difference is how they are built. Tarmac is laid by a paving machine, and a plane is what it should be — a sealed section is a public road the rally borrowed, and it reads as one precisely because it is the smooth part. Gravel is bladed, driven on, frozen and bladed again, and that leaves a good surface with things wrong with it HERE AND THERE: a frost heave, a hollow worn at a corner exit, a stone the blade rode over. So the bumps are SPARSE impulses, not a continuous grain — a continuous grain is a washboard however small you make it, wrong in the same way an evenly-sprinkled forest is wrong, because real defects come in ones with clean road between them. Each is a raised cosine, meeting the road at zero height and zero slope so it joins the surface instead of stepping onto it, and each is marginal: a few centimetres is a road with a surface, ten is a pothole. The gravel's WIDTH wanders too, by about a tenth either way over hundreds of metres, because a blade cuts wider on one pass than the next and the verges creep in where nothing has run wide for a season. Sealed road, bridge decks and the graded aprons of fords take none of it: no bumps, and the nominal width exactly.
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rollers`   | A rank of balls the width of a wheel, rolled down the stage side by side over the mat and both verges: steps along a lane, walls and trenches across the rank, hollows, water on the road, ANYTHING standing in it (solid or not — the wild's trunks and boulders, R26's marker posts, and R17's barriers), and R16's hand-over, scored twice over: the EDGE, as the grade the ground takes across the corridor's outer band, and the SEAM, as the worst STEP in it — a fall of any steepness is a hillside, a kink is a face at the road's edge, and only the second is always wrong |
...
| `roads`     | R17/R23 as a network: every branch runs off the map, a SEALED one does it still sealed and never turns to gravel on the way, no two roads share ground, none run side by side, and how the roads are spread over the country                                                                                                                                                                                                                                                                                                                                                          |
...
Most checks are ceilings: less is better and zero is perfect. Three are **bands**, and they are the ones that catch a stage for being too clean rather than too broken — how often the gravel has a bump in it (a road that measures zero is one nobody bladed or drove on), the road's width, and how much the rideable corridor pinches and opens out. A generator with only ceilings on it optimises toward a plane.
